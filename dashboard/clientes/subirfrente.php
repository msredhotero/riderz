...
if (!isset($_SESSION['usua_sahilices']))
{
	...
	$carpeta = mysql_result($resUsuario,0,0);
	 ...
	 $dir_destino = '../../data/'.$carpeta.'/1/';

	 $serviciosReferencias->borrarDirecctorio($dir_destino);
	 $serviciosReferencias->modificarClienteImagenFrentePorIdCliente($idcliente, $name, 'fotofrente');
	 ...
	 // desarrollo
	 $nuevo_noentrar = '../../data/'.$carpeta.'/1/'.'index.php';
