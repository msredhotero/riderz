...
(1, '../index.php', 'icodashboard', 'Dashboard', 1, NULL, 'Administrador, Empleado, Cliente'),
(8, '../logout.php', 'icosalir', 'Salir', 30, NULL, 'Administrador, Empleado, Cliente'),
(18, '../clientes/', 'icoconfiguracion', 'Clientes', 2, NULL, 'Administrador, Empleado'),
